...
} else if (intentos == 5) { // Si nos hemos salido del bucle porque la contraseña suministrada no es correcta
                            // y hemos llegado-superado el número máximo de intentos.
