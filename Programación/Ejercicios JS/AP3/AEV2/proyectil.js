...
function coordY(beta, alfa,v,t) {
    let y;
    v = 40/2;
    y = ((beta * Math.sin(alfa) * t) - v * (t *t)); // (beta * Math.sin(alfa) *t) - 20 * t * t;
    return y;
}
...
let readlineSync, alfa, beta, ejeX, ejeY, maxY, maxX, tTotal, t;
tTotal = 0;
ejeY = 100;
maxX = 0;
maxY = 0;
